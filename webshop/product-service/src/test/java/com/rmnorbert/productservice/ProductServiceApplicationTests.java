package com.rmnorbert.productservice;
...
class ProductServiceApplicationTests {
	...
	void shouldCreateProduct() throws Exception {
		...
		int numberOfRecordInDatabase = 1;
        ...
        Assertions.assertEquals(numberOfRecordInDatabase, productRepository.findAll().size());
	}

	private ProductRequest getProductRequest() {
		return ProductRequest.builder()
				.name("Super Light Sugar")
				.description("Fat reduced bio organic sugar")
